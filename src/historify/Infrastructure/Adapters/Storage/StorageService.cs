...
namespace Infrastructure.Adapters.Storage
{
    public class StorageService : IStorageService
    {
        ...
        public async Task DeleteAsync(string pathOrContainerName) => await _storage.DeleteAsync(pathOrContainerName);
        ...
        public Task<Stream> DownloadAsync(string pathOrContainerName) => _storage.DownloadAsync(pathOrContainerName);
